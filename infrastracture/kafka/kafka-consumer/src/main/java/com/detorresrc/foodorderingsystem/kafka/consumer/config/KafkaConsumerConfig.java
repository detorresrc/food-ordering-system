package com.detorresrc.foodorderingsystem.kafka.consumer.config;

import com.detorresrc.foodorderingsystem.kafka.config.data.KafkaConfigData;
import com.detorresrc.foodorderingsystem.kafka.config.data.KafkaConsumerConfigData;
